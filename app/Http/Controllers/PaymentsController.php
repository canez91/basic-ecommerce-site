...
class PaymentsController extends Controller
{
    ...
    public function pay(Request $request){
    	...
    	//filtra los enlaces y regresa solo aquellos con el método REDIRECT. El resto que NO COINCIDE quedan como NULL.
    	$redirectLinks = array_filter( $response->result->links , function($link){
    	  return $link->method == "REDIRECT";	
    	});

    	//Limpia el arreglo quitando aquellos elementos con un value NULL.
